    ...
    return (
        <>
            <div className="explain_contents">
                ...
                <br/>
                <p>
                침투 테스트(Penetration Test)는 컴퓨터 시스템이나 네트워크, 웹 어플리케이션에 모의 공격을 수행해 공격자가 악용할 수 있는 보안상의 취약점을 찾아내는 예방 차원의 보안 행위입니다.<br/>
                ...
                WhitePen 서비스에서 제공하는 공격은 다음과 같습니다.
                </p>
            </div>
        </>
    )
        ...
        return (
            <>
                <div className="explanation_container" ref={this.container}>
                    ...
                    <div className="explain_content_container">
                        IV
                    </div>
                </div>
            </>
